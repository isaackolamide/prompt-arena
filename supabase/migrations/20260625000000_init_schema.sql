...
-- During local development, the real auth schema, auth.users table, and auth.uid() function are automatically managed by Supabase.
-- So we do not recreate or modify them here in migrations.
